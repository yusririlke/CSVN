...
screen game_over():
    ...
    textbutton 'RETRY' action Hide('game_over'), Jump('tetris_reload5') align .5,.9
    textbutton 'Continue' action Hide('game_over'), Jump('continue5') align .5,.8
...
screen difficulty_choice():
    ...
    vbox align .5,.5 spacing 30:
        text 'Controls:'align .5,.5 size 60 color '#fff'
        text 'Use up arrow to rotate'align .5,.5 size 60 color '#fff'
        text 'Use left and right arrows to move block'align .5,.5 size 60 color '#fff'
        text 'Use bottom arrow to speed up or slow down block'align .5,.5 size 60 color '#fff'
